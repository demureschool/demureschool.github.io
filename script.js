...
if(!supabaseReady){
  console.warn("Supabase belum dikonfigurasi/gagal terhubung — situs memakai data contoh (fallback) di script.js. Isi SUPABASE_URL dan SUPABASE_ANON_KEY untuk menyambungkan ke database sungguhan.");
}
...
document.addEventListener("DOMContentLoaded", async () => {
  try{
    ...
    console.error("Gagal memuat data awal, pakai data cadangan.", err);
